...
public class MultiItemStackSelectorAPI {
    ...
    public MultiItemStackSelectorAPI(Player p, ArrayList<ItemStack> items, BiFunction<InventoryClickEvent, ArrayList<ItemStack>, String> okFunction, Function<InventoryClickEvent, String> cancelFucntion){
        ...
        inventory.setItem(new int[]{45,46,47,48,49,50,51,52,53}, new SItemStack(Material.BLUE_STAINED_GLASS_PANE).setDisplayname(" ").build());
        inventory.setItem(new int[]{48,49,50}, new SItemStack(Material.RED_STAINED_GLASS_PANE).setDisplayname("§c§l決定する").build());

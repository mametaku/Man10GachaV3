...
public class GachaItemStackSettingsMenu {
    ...
    public void createMenu(int startCategory, int startPage){
        ...
        generalSettingsItem.add(renderItemList(new SItemStack(Material.COMMAND_BLOCK).setDisplayname("§e§l§nプレイヤー実行コマンド設定"), gItemStack.playerCommand));
        generalSettingsItem.add(renderItemList(new SItemStack(Material.COMMAND_BLOCK).setDisplayname("§e§l§nサーバー実行コマンド設定"), gItemStack.serverCommand));
        ...
        if(gItemStack.playerTitle != null){
            ...
            messageSettings.add(new SItemStack(Material.LEGACY_SIGN).setDisplayname("§6§l§nプレイヤー表示タイトル設定").addLore("§b§lメインテキスト：" + map.get("mainText")).addLore("§b§lサブテキスト：" + map.get("subText")).addLore("§b§lフェードイン時間：" + map.get("fadeInTime")).addLore("§b§l表示時間：" + map.get("time")).addLore("§b§lフェードアウトタイム：" + map.get("fadeOutTime")).build());
        }else{messageSettings.add(new SItemStack(Material.LEGACY_SIGN).setDisplayname("§6§l§nプレイヤー表示タイトル設定").addLore("§b§l現在設定：なし").build());}
        if(gItemStack.serverTitle!= null){
            Map<String, String> map = gItemStack.serverTitle.getStringData();
            messageSettings.add(new SItemStack(Material.LEGACY_SIGN).setDisplayname("§6§l§nサーバー表示タイトル設定").addLore("§b§lメインテキスト：" + map.get("mainText")).addLore("§b§lサブテキスト：" + map.get("subText")).addLore("§b§lフェードイン時間：" + map.get("fadeInTime")).addLore("§b§l表示時間：" + map.get("time")).addLore("§b§lフェードアウトタイム：" + map.get("fadeOutTime")).build());
        }else{messageSettings.add(new SItemStack(Material.LEGACY_SIGN).setDisplayname("§6§l§nサーバー表示タイトル設定").addLore("§b§l現在設定：なし").build());}
        ...
        categories.add(new CategorizedMenuCategory(new SItemStack(Material.WRITABLE_BOOK).setDisplayname("§6§n§lメッセージ設定").build(), messageSettings));
        ...
        categories.add(new CategorizedMenuCategory(new SItemStack(Material.CHEST_MINECART).setDisplayname("§8§n§lアイテムバンク設定").build(), itemBankSettings));

...
public class GachaPlayGame {
    ...
    public GachaPlayGame(Player p, GachaGame game){
        ...
        invee.fillInventory(new SItemStack(Material.BLUE_STAINED_GLASS_PANE).setDisplayname(" ").build());
        invee.setItem(new int[]{4,22}, new SItemStack(Material.RED_STAINED_GLASS_PANE).setDisplayname("§c§l||").build());
